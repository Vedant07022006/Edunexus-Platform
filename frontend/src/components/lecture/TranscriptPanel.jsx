...
// Words are grouped into fixed-size chunks so the search feature works over
// readable snippets instead of single words (AssemblyAI gives per-word
// timestamps, which are too granular to search/display individually).
const CHUNK_SIZE = 14;
