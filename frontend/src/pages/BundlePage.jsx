...
import { getAllBundles, createBundleOrder, verifyBundlePayment } from '../services/api.service';
  ...
  const handleBuy = async (bundle) => {
    ...
    try {
      ...
      const rzp = new window.Razorpay({
        key: keyId,
        amount: amount, // already in paise from the backend (Razorpay returns paise)
        currency,
        name: 'EduNexus',
